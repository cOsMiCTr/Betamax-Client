...
export class ProfileView extends React.Component {
  ...
  getUserDetails(token) {
    ...
    axios.get(`https://betamax-cosmictr.herokuapp.com/users/${this.props.user}`, {
...
updateUserDetails(e) {
    ...
    if (form.checkValidity() === false) {
        ...
        axios.put(`https://betamax-cosmictr.herokuapp.com/users/${user}`, {
...
deleteUserDetails() {
    let token = localStorage.getItem('token');
    let user = localStorage.getItem('user');
    axios.delete(`https://betamax-cosmictr.herokuapp.com/users/${user}`, {
        headers: { Authorization: `Bearer ${token}`}
    }).then(response => {
        const data = response.data;
